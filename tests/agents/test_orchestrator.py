...
class OrchestratorAgent(BaseAgent):
    ...
    async def analyze_intent(self, user_input: str) -> str:
        """Classifie l'intention : CHAT, CODE_EXECUTION, VIDEO_ANALYSIS, TREND_SEARCH, SYSTEM_STATUS"""
        prompt = (
            ...
            "- TREND_SEARCH (demande de rechercher des tendances, actualités ou sujets chauds)\n"
            "- CHAT (discussion générale, question, bonjour, politesse)\n\n"
        ...
        try:
            ...
            if "CODE" in intent or "SCRIPT" in intent or "PROGRAMME" in intent:
