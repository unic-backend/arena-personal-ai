...
| **DEC-0106** | **le fil du serveur est relu, et seulement sous `conversation_id`** | le téléphone coupe à 8 messages ; le serveur a tout, sous la session du fil — mais le seau commun « pwa » n'est jamais relu |
