...
Cinq sont branchés (la vidéo à l'agent vidéo, les documents au chemin
documentaire, le sens à la mémoire du chat) ; **quatre dorment encore**. La mission est de les brancher, un par
...
**Ce qui existe mais n'est branché nulle part** : quatre modules réels et testés,
