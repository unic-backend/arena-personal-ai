...
- 2026-08-26 : Passerelle `/v1` finalisée, 8 agents exposés comme modèles (`00e8f4f`).
- 2026-08-26 : Quatre rapports d'audit externes — sécurité notée 3/10, 7 vulnérabilités.
- 2026-08-26 : Phase 7 bis ouverte. 12 correctifs livrés, chacun avec sa vérification :
  clé hors du dépôt, authentification `/api/*`, CORS restreint, bac à sable qui refuse
